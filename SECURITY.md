...
Security fixes are provided for **currently supported release lines** of `switon/http-client` (`switon/http-client` on Packagist).
...
1. **GitHub private vulnerability reporting (preferred)**  
   [Report a vulnerability](https://github.com/switon-php/http-client/security/advisories/new)
